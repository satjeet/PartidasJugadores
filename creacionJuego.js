/// Era la idea inicial, no se ha usado en este proyecto

FabricaJuegos={}

FabricaJuegos.crearJuego=function(playerIds){
    var players=crearJugadores(playersIds);
...
function crearJugadores(playersIds){
    var datos={};
